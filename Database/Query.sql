...
create table tblNhanVien(
	...
	ma_chuc_vu int REFERENCES tblChucVu(ma_chuc_vu)
);
...
create table tblTinNhan(
	...
	ngay_gui datetime,
	ma_kh nvarchar(50) references tblKhachHang(ma_kh),
	ho_ten nvarchar(100),
	mail nvarchar(100),
...
create table tblPhong(
	...
	loai_phong int references tblLoaiPhong(loai_phong),
	ma_tang int references tblTang(ma_tang),
	ma_tinh_trang int REFERENCES tblTinhTrangPhong(ma_tinh_trang)
);
...
create table tblPhieuDatPhong(
	...
	ngay_vao datetime,
	ngay_ra datetime,
	ma_phong int REFERENCES tblPhong(ma_phong),
	thong_tin_khach_thue nvarchar(400),
	ma_tinh_trang int REFERENCES tblTinhTrangPhieuDatPhong(ma_tinh_trang)
);
...
create table tblHoaDon(
	...
	ma_nv int REFERENCES tblNhanVien(ma_nv),
	ma_pdp int REFERENCES tblPhieuDatPhong(ma_pdp),
	ngay_tra_phong datetime,
	ma_tinh_trang int REFERENCES tblTinhTrangHoaDon(ma_tinh_trang),
	tien_phong float,
	tien_dich_vu float,
	phu_thu float,
	tong_tien float
...
create table tblDichVuDaDat(
	...
	ma_hd int REFERENCES tblHoaDon(ma_hd),
	ma_dv int REFERENCES tblDichVu(ma_dv),
	so_luong int
);
